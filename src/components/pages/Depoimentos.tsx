...
export default function Depoimentos() {
  const getCardClasses = (index: number) => {
    ...
    return `${baseClass} bg-[#f4eee0] text-[#161117] ${isWide ? 'md:col-span-2' : ''} ${isSquare ? 'md:col-span-1' : ''} md:row-span-1`;
  };
        ...
        >
          {CLIENT.depoimentos.map((dep, i) => (
            ...
            >
              ...
              {/* Texto do Depoimento */}
              <p className={`mt-6 lg:mt-8 mb-8 text-lg lg:text-xl xl:text-2xl font-medium leading-normal tracking-tight ${i === 0 ? 'text-white/95' : 'text-[#161117]/90'}`}>
                "{dep.texto}"
              </p>
