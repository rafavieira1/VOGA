            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  {/* Avatar com Iniciais */}
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center text-xs font-bold shrink-0 border border-[#e7b167]/20 ${i === 0
                  ...
                  <div className="flex items-center gap-1.5 font-bold text-sm">
                    <span className="font-['Lora'] font-medium text-lg leading-none tracking-tighter">{dep.nota}.0</span>
