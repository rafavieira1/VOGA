...
export default function Estatisticas() {
  return (
    <section className="relative w-full min-h-[500px] sm:min-h-[600px] lg:min-h-[600px] flex items-center bg-[#234932] overflow-hidden py-16 lg:py-32">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#234932]/60 via-[#234932]/20 to-[#234932]/60 pointer-events-none" />
      ...
      <div className="container relative z-10 mx-auto px-6 max-w-[1400px]">
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 lg:gap-12">
          ...
          >
            ...
            <h2 className="text-4xl sm:text-5xl lg:text-6xl text-[#e7b167] font-normal leading-[1.1] tracking-tight">
