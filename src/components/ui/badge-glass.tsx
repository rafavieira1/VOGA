    ...
    <div className={cn(
      ...
      <span className={cn(
        ...
        variant === "light"
          ...
          : "bg-gradient-to-b from-[#234932] to-[#234932]/80 border border-[#e7b167]/30 text-white/90 group-hover:text-white shadow-[inset_0_-3px_5px_rgba(0,0,0,0.2),inset_0_2px_4px_rgba(255,255,255,0.1),inset_0_0_0_1px_rgba(255,255,255,0.05)]"
      )}>
        {children}
      </span>
    </div>
